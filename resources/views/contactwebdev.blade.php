            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="bg-gradient-to-br from-indigo-500 to-purple-700 p-8 text-white flex flex-col justify-between">
                        <div>
                            <h2 class="text-4xl font-extrabold mb-4">Web-Developing | Frontend | Backend</h2>
                            <p class="text-lg mb-6">Been learn to do both front-end and back-end of website, also CMS like Wordpress. If you desired to showcase your business on web, I'm here to help you</p>
                            <ul class="space-y-4">
                        ...
                        <div class="mt-6">
                            <h3 class="text-xl font-bold">Web Developing</h3>
                            <img src="{{ URL('images/website_horizontal.jpg') }}" alt="website development">
                        </div>
                    </div>
